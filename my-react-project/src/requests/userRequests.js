...
export default class userRequests {
    static async createAccount(data) {
        ...
        return await axios.get("https://blogging-site-example.onrender.com/api/v1/users", data);
    }
    static async deleteAccount(id) {
        //return await axios.delete("http://localhost:8080/api/v1/users", {data:{id:id}}); 
        return await axios.get("https://blogging-site-example.onrender.com/api/v1/users", {data:{id:id}});
    }
    static async signUser(data) {
        //return await axios.post("http://localhost:8080/api/v1/users/signin", data); 
        return await axios.get("https://blogging-site-example.onrender.com/api/v1/users/signin", data);
    }
